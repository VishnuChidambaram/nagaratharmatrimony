...
export default function Step5() {
  ...
  const renderAmsamBox = (pos) => {
    if (pos === "center") return <div className="center-box">அம்சம்</div>;
  ...
  return (
    <>
      ...
      <h2>
        <b>{t("Choose for Rasi-ராசி", language)}</b>
      </h2>
      ...
      <br></br>
      <h2>
        <b>{t("Choose for Amsam-அம்சம்", language)}</b>
      </h2>
      ...
      <div style={styles.formContainer} className="button-container">
        <div style={styles.leftColumn}>
          <button
            ...
            onClick={() => router.push("/register/4")}
          >
            {t("Previous", language)}
          </button>
        </div>
