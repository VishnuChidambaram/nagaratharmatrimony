...
const FIELD_GROUPS = {
  ...
  "Partner Preference": [
    ...
    { key: "otherEducation1", label: "Partner Other Education" },
    { key: "educationDetails1", label: "Partner Education Details" },
    { key: "occupationBusiness1", label: "Partner Occupation/Business" },
    { key: "otherOccupation1", label: "Partner Other Occupation" },
    { key: "workingPlace1", label: "Partner Working Place" },
